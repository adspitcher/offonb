...
public class AddCategoriesActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		button_addnew.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View view) {
				NewDialogFragment addCategoryDialog = new NewDialogFragment();
				addCategoryDialog.show(manager, "Add");
			}
		});
	}
